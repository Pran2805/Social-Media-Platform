...
function Home() {
  ...
  const handleAddComment = (postId, commentInput) => {
    ...
    <div className="max-w-3xl mx-auto p-4">
      ...
      {Array.isArray(posts) &&
        posts?.map((post) => (
          <div
            key={post._id}
            className="border border-gray-300 p-4 mb-6 shadow-sm"
          >
            ...
            {post.file && (
              <div className="mt-4">
                {post.file.includes(".mp4") ? (
                  <video width="320" height="240" controls>
                    <source
                      ...
                      type="video/mp4"
                    />
                    {/* {console.log(`Trying to load video: ${post.file}`)} */}
                ...
                {console.log(`File type: ${post.file.split(".").pop()}`)}
              </div>
            )}
            ...
            <button
              ...
              className="bg-blue-500 text-white py-2 px-4 mt-2 rounded hover:bg-blue-600 ml-2"
            >
              Add Comment
            </button>
          </div>
